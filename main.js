...
class Calculator {
   ...
   appendNumber(number) {
    ...
    updateDisplay() {
    this.currentOperandTextElemet.innerText = this.getDisplayNumber(this.currentOperand);
...
const calculator = new Calculator(previousOperandTextElement, currentOperandTextElemet);
